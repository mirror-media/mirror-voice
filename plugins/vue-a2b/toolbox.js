...
export function getCookie(name, isUniversal = false) {
  if (isUniversal) {
...
export function writeCookie(name, data, expiry, isUniversal = false) {
  if (getCookie(name, isUniversal)) {
    return
  }
